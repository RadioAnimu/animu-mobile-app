...
const DICT = {
  ...
  SETTINGS_QUALITY_LIVE_LABEL: "Image quality (all covers):",
  ...
  SETTINGS_STORAGE_MANAGE: "Storage details",
  STORAGE_EXPLAIN:
  ...
  LOGIN_ANIMU_CONNECT_HINT:
    "Animu Connect must be set up in your profile before you can use it.",
  LOGIN_CONNECT_SUBTITLE: "Use your Animu Connect username and password",
  LOGIN_USERNAME: "Username",
  LOGIN_USERNAME_PLACEHOLDER: "Your Animu Connect username",
  ...
  ACCOUNT_SHOW: "Show",
  ACCOUNT_HIDE: "Hide",
  ACCOUNT_TAP_TO_REVEAL: "Tap to reveal",
  ...
  ACCOUNT_ANIMU_CONNECT_DESC: "Sign in with a username and password.",
  ACCOUNT_ANIMU_CONNECT_READY: "Configured",
  ACCOUNT_ANIMU_CONNECT_READY_AS: "Configured as {username}",
  ACCOUNT_ANIMU_CONNECT_SETUP: "Set up",
  ACCOUNT_ANIMU_CONNECT_UPDATE: "Update",
  ACCOUNT_ANIMU_CONNECT_FORM_HINT:
    "Set or change your Animu Connect credentials.",
  ACCOUNT_AVATAR: "Avatar",
  ACCOUNT_AVATAR_UPLOAD: "Upload image",
  ACCOUNT_AVATAR_RESET: "Reset to provider avatar",
  ACCOUNT_AVATAR_UPDATED: "Avatar updated",
  ACCOUNT_AVATAR_RESET_DONE: "Avatar reset",
  ACCOUNT_IMAGE_PERMISSION: "Allow photo access to change your avatar.",
  ...
  ACCOUNT_CREDENTIALS_FAILED: "Check your current password and try again.",
  ACCOUNT_CREDENTIALS_SAVED: "Animu Connect updated",
  ACCOUNT_SAVE: "Save",
  ACCOUNT_NEW_PASSWORD: "New password",
  ACCOUNT_CURRENT_PASSWORD: "Current password",
  ACCOUNT_CURRENT_PASSWORD_REQUIRED: "Enter your current password.",
  ACCOUNT_CURRENT_PASSWORD_PLACEHOLDER: "Required to make changes",
  SETTINGS_ACCOUNT_MANAGE: "Manage",
