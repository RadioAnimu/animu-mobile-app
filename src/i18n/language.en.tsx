...
const DICT = {
  ...
  SETTINGS_ACCOUNT_CONNECTED: "Connected to Discord",
  SETTINGS_ACCOUNT_LOGOUT: "Log out",
  ...
  SETTINGS_QUALITY_LIVE_OFF_HINT: "Do not load cover images",
  ...
  SETTINGS_OSCILLOSCOPE_TITLE: "Oscilloscope",
  SETTINGS_VISUALIZER_SWITCH: "Audio visualizer:",
  SETTINGS_VISUALIZER_HZ_LABEL: "Refresh rate:",
  SETTINGS_VISUALIZER_OFF: "Off",
  SETTINGS_VISUALIZER_VSYNC: "vsync",
  SETTINGS_VISUALIZER_COMING_SOON: "Coming soon (iOS)",
