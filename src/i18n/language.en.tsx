...
const DICT = {
  ...
  MENU_MAKE_REQUEST: "Make a Request",
  LINKS: "Links",
  ...
  SETTINGS_STORAGE_PLAYED: "Recently played",
  SETTINGS_STORAGE_SEARCH: "Request search",
  SETTINGS_STORAGE_EMPTY: "No covers cached yet",
  ...
  SETTINGS_STORAGE_FREE_UP: "Free up space",
  ...
  STATS_SETTINGS_ROW: "Listen stats",
  STATS_TITLE: "Listening stats",
  STATS_OVERVIEW_TITLE: "Overview",
  STATS_TOTAL: "Total listening",
  STATS_DAYS: "Days listening",
  STATS_SESSIONS: "Sessions",
  STATS_SONGS: "Songs heard",
  STATS_REQUESTED: "Requested songs heard",
  STATS_REQUESTS_SENT: "Requests sent",
  STATS_SHOUTOUTS: "Live shout-outs",
  STATS_STREAK_TITLE: "Streak",
  STATS_STREAK_CURRENT: "Current streak",
  STATS_STREAK_LONGEST: "Longest streak",
  STATS_STREAK_DAYS: "{n} days",
  STATS_STREAK_DAY: "1 day",
  STATS_HEATMAP_TITLE: "Heatmap",
  STATS_HEATMAP_HINT: "Last 6 months — tap a day for details",
  STATS_LESS: "Less",
  STATS_MORE: "More",
  STATS_PROFILE_TITLE: "Listening profile",
  STATS_PROFILE_HOURS: "By hour of day",
  STATS_PROFILE_WEEKDAYS: "By weekday",
  STATS_PROFILE_EMPTY: "Not enough listening recorded yet",
  STATS_EMPTY_TITLE: "No listening recorded yet",
  STATS_EMPTY:
  ...
  ABOUT_RELEASE_ROW: "Release",
  ABOUT_OTA_VERSION_ROW: "OTA version",
  ABOUT_OTA_BUILTIN: "Built-in",
  ABOUT_OTA_LOADING: "…",
  ABOUT_PACKAGE_ROW: "Package",
  ABOUT_RELEASE_APP_STORE: "App Store",
  ABOUT_RELEASE_ADHOC: "AltStore (Ad-Hoc)",
  ABOUT_RELEASE_DEVELOPMENT: "Development",
  ABOUT_RELEASE_SIMULATOR: "Simulator",
  ...
  STORAGE_CLEAR_CONFIRM_TITLE: "Free up space?",
  STORAGE_CLEAR_CONFIRM_MSG:
    "All saved covers will be deleted. They'll download again the next time you listen.",
  ...
  STORAGE_PARTITION_AUTO: "Automatic",
  STORAGE_PARTITION_CAP_DESC: "Effective cap: {cap}",
  STORAGE_PARTITION_NEEDS_LIMIT: "Set a size limit to customize the partitions",
  STORAGE_FREED: "Freed {freed}",
  ...
  REQUEST_ERROR_BLOCOBLOCK: "Requests are currently disabled.",
  REQUEST_ERROR_NOLOGIN: "Your session expired. Please log in again.",
  REQUEST_ERROR_NO2FA: "You need 2FA enabled on Discord to make requests.",
  REQUEST_ERROR_PANEL:
  ...
  LOGIN_TITLE: "Sign in",
  LOGIN_SUBTITLE: "Choose how you want to continue",
  LOGIN_OR: "or",
  ...
  LOGIN_CODE_CHANGE_EMAIL: "Use a different email",
  LOGIN_CODE_INVALID: "That code is invalid or expired. Try again.",
  ...
  ACCOUNT_ACTION_FAILED: "Action failed. Try again.",
  ACCOUNT_SAVE: "Save",
  ACCOUNT_EMAIL_ADD: "Add email",
  ACCOUNT_EMAIL_SAVED: "Email saved",
  ACCOUNT_EMAIL_TAKEN: "That email is already in use.",
  ACCOUNT_EMAIL_REMOVE: "Remove",
  ACCOUNT_EMAIL_REMOVED: "Email removed",
