...
const DICT = {
  ...
  QUEUE_IN_LINE: "You're in line! 🎶",
  QUEUE_PLAYED_AHEAD: "≥%1 played ahead of yours",
  QUEUE_CADENCE: "requests play about every ~%1 min",
  QUEUE_PLAYING_NOW: "Your request is playing now! 🎶",
