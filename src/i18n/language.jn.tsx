...
const DICT: Dict = {
  ...
  STATS_SONGS: "聴いた曲",
  STATS_REQUESTED: "リクエスト曲",
  STATS_REQUESTS_SENT: "リクエスト送信",
  STATS_SHOUTOUTS: "生メッセージ",
  STATS_STREAK_TITLE: "連続記録",
  STATS_STREAK_CURRENT: "現在の連続記録",
  ...
  STATS_LESS: "少ない",
  STATS_MORE: "多い",
  STATS_PROFILE_TITLE: "視聴プロファイル",
  STATS_PROFILE_HOURS: "時間帯別",
  STATS_PROFILE_WEEKDAYS: "曜日別",
  STATS_PROFILE_EMPTY: "まだ十分な視聴データがありません",
  STATS_EMPTY_TITLE: "視聴データはまだありません",
  STATS_EMPTY:
