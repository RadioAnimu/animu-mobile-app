...
const DICT = {
  ...
  SETTINGS_ACCOUNT_CONNECTED: "ディスコードに接続中",
  SETTINGS_ACCOUNT_LOGOUT: "ログアウト",
  SETTINGS_SAVE_DATA_TITLE: "データ保存",
  SETTINGS_QUALITY_LIVE_LABEL: "ライブ画質：",
  ...
  SETTINGS_QUALITY_LIVE_OFF_HINT: "カバー画像を読み込まない",
  SETTINGS_COVER_LIVE_LABEL_SWITCH: "ライブカバー表示：",
  SETTINGS_COVER_LAST_REQUESTED_SWITCH: "最後のリクエストカバー表示：",
  SETTINGS_COVER_LAST_PLAYED_SWITCH: "最後に流れたカバー表示：",
  ...
  SETTINGS_VISUALIZER_HZ_LABEL: "リフレッシュレート：",
  SETTINGS_VISUALIZER_OFF: "オフ",
  ...
  LOGIN_ANIMU_CONNECT_HINT:
    "Animu Connect を使うには、プロフィールで設定しておく必要があるよ。",
  LOGIN_CONNECT_SUBTITLE: "Animu Connect のユーザー名とパスワードを入力してね",
  LOGIN_USERNAME: "ユーザー名",
  LOGIN_USERNAME_PLACEHOLDER: "Animu Connect のユーザー名",
  ...
  ACCOUNT_ANIMU_CONNECT_DESC: "ユーザー名とパスワードでログイン。",
  ACCOUNT_ANIMU_CONNECT_READY: "設定済み",
  ACCOUNT_ANIMU_CONNECT_READY_AS: "{username} で設定済み",
  ACCOUNT_ANIMU_CONNECT_SETUP: "設定",
  ACCOUNT_ANIMU_CONNECT_UPDATE: "更新",
  ACCOUNT_ANIMU_CONNECT_FORM_HINT:
    "Animu Connect のログイン情報を設定・変更してね。",
  ACCOUNT_AVATAR: "アバター",
  ACCOUNT_AVATAR_UPLOAD: "画像をアップロード",
  ACCOUNT_AVATAR_RESET: "プロバイダーのアバターに戻す",
  ACCOUNT_AVATAR_UPDATED: "アバターを更新したよ",
  ACCOUNT_AVATAR_RESET_DONE: "アバターを戻したよ",
  ACCOUNT_IMAGE_PERMISSION: "アバターを変えるには写真へのアクセスを許可してね。",
  ...
  ACCOUNT_CREDENTIALS_FAILED:
    "現在のパスワードを確認してもう一度試してね。",
  ACCOUNT_CREDENTIALS_SAVED: "Animu Connect を更新したよ",
  ACCOUNT_SAVE: "保存",
  ACCOUNT_NEW_PASSWORD: "新しいパスワード",
  ACCOUNT_CURRENT_PASSWORD: "現在のパスワード",
  ACCOUNT_CURRENT_PASSWORD_REQUIRED: "現在のパスワードを入力してね。",
  ACCOUNT_CURRENT_PASSWORD_PLACEHOLDER: "変更に必要だよ",
  SETTINGS_ACCOUNT_MANAGE: "管理",
