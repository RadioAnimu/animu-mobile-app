...
const DICT = {
  ...
  SETTINGS_ACCOUNT_CONNECTED: "Conectado ao Discord",
  SETTINGS_ACCOUNT_LOGOUT: "Sair da conta",
  ...
  SETTINGS_QUALITY_LIVE_OFF_HINT: "Não carregar imagens de capa",
  ...
  SETTINGS_VISUALIZER_HZ_LABEL: "Taxa de Hz:",
  SETTINGS_VISUALIZER_OFF: "Desligado",
