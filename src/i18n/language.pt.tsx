...
import logo from "@/assets/logo_PT.webp";
import makeRequest from "@/assets/make_request_harukinha_pt.webp";
import lastPlayed from "@/assets/last_played-haru_pt.webp";
import lastRequested from "@/assets/last_requested-haru_pt.webp";
...
const DICT: Dict = {
  ...
  SETTINGS_STORAGE_PLAYED: "Tocadas recentemente",
  SETTINGS_STORAGE_SEARCH: "Busca de pedidos",
  SETTINGS_STORAGE_EMPTY: "Nenhuma capa guardada por enquanto",
  ...
  SETTINGS_STORAGE_FREE_UP: "Liberar espaço",
  ...
  A11Y_OPENS_SETTINGS: "Abre as configurações",
  A11Y_OPENS_LOGIN: "Abre o login",
  ...
  // ── Listen stats (on-device) ──
  STATS_SETTINGS_ROW: "Estatísticas de escuta",
  STATS_TITLE: "Estatísticas de escuta",
  STATS_OVERVIEW_TITLE: "Visão geral",
  STATS_TOTAL: "Tempo total ouvindo",
  STATS_DAYS: "Dias ouvindo",
  STATS_SESSIONS: "Sessões",
  STATS_SONGS: "Músicas ouvidas",
  STATS_REQUESTED: "Pedidas ouvidas",
  STATS_REQUESTS_SENT: "Pedidos enviados",
  STATS_SHOUTOUTS: "Pedidos ao vivo",
  STATS_STREAK_TITLE: "Sequência",
  STATS_STREAK_CURRENT: "Sequência atual",
  ...
  STATS_LESS: "Menos",
  STATS_MORE: "Mais",
  STATS_PROFILE_TITLE: "Perfil de escuta",
  STATS_PROFILE_HOURS: "Por hora do dia",
  STATS_PROFILE_WEEKDAYS: "Por dia da semana",
  STATS_PROFILE_EMPTY: "Ainda não há escuta suficiente registrada",
  STATS_EMPTY_TITLE: "Nenhuma escuta registrada ainda",
  STATS_EMPTY:
  ...
  ABOUT_RELEASE_ROW: "Distribuição",
  ABOUT_OTA_VERSION_ROW: "Versão OTA",
  ABOUT_OTA_BUILTIN: "Embutida",
  ABOUT_OTA_LOADING: "…",
  ABOUT_PACKAGE_ROW: "Pacote",
  ABOUT_RELEASE_APP_STORE: "App Store",
  ABOUT_RELEASE_ADHOC: "AltStore (Ad-Hoc)",
  ABOUT_RELEASE_DEVELOPMENT: "Desenvolvimento",
  ABOUT_RELEASE_SIMULATOR: "Simulador",
  ...
  STORAGE_EXPLAIN:
    "Guardamos as capas das músicas no seu aparelho para elas carregarem mais rápido e usarem menos dados.",
  STORAGE_FREE_UP: "Liberar espaço",
  STORAGE_CLEAR_CONFIRM_TITLE: "Liberar espaço?",
  STORAGE_CLEAR_CONFIRM_MSG:
    "Todas as capas guardadas serão apagadas. Elas voltam a ser baixadas quando você ouvir músicas novamente.",
  ...
  REQUEST_ERROR_NO2FA:
    "Você precisa ter a 2FA ativada no Discord para fazer pedidos.",
  REQUEST_ERROR_PANEL:
  ...
  FORM_PLACEHOLDER_MUSIC: "Digite o nome da música",
  FORM_PLACEHOLDER_ANIME: "Digite o nome do anime, visual novel ou jogo",
  FORM_PLACEHOLDER_REQUEST: "Digite um recado para o locutor",
  OK_BUTTON: "OK",
  ...
  LOGIN_CODE_CHANGE_EMAIL: "Usar outro e-mail",
  LOGIN_CODE_INVALID: "Código inválido ou expirado. Tente de novo.",
  LOGIN_BUTTON: "Entrar",
  ACCOUNT_TITLE: "Conta",
  ...
  ACCOUNT_ACTION_FAILED: "A ação falhou. Tente novamente.",
  ACCOUNT_SAVE: "Salvar",
  ACCOUNT_EMAIL_ADD: "Adicionar e-mail",
  ACCOUNT_EMAIL_SAVED: "E-mail salvo",
  ACCOUNT_EMAIL_TAKEN: "Esse e-mail já está em uso.",
