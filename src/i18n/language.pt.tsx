...
const DICT = {
  ...
  QUEUE_IN_LINE: "Você está na fila! 🎶",
  QUEUE_PLAYED_AHEAD: "≥%1 pedidos tocaram antes do seu",
  QUEUE_CADENCE: "pedidos tocam a cada ~%1 min",
  QUEUE_PLAYING_NOW: "Seu pedido está tocando agora! 🎶",
