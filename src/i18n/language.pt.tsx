...
const DICT = {
  ...
  SETTINGS_QUALITY_LIVE_LABEL: "Qualidade das imagens (todas as capas):",
  ...
  SETTINGS_STORAGE_MANAGE: "Detalhes do armazenamento",
  STORAGE_EXPLAIN:
  ...
  LOGIN_ANIMU_CONNECT_HINT:
    "O Animu Connect precisa estar configurado no seu perfil antes de usar aqui.",
  LOGIN_CONNECT_SUBTITLE: "Use seu usuário e senha do Animu Connect",
  LOGIN_USERNAME: "Usuário",
  LOGIN_USERNAME_PLACEHOLDER: "Seu usuário Animu Connect",
  ...
  ACCOUNT_TAP_TO_REVEAL: "Toque para ver",
  ...
  ACCOUNT_ANIMU_CONNECT_DESC: "Entre com usuário e senha.",
  ACCOUNT_ANIMU_CONNECT_READY: "Configurado",
  ACCOUNT_ANIMU_CONNECT_READY_AS: "Configurado como {username}",
  ACCOUNT_ANIMU_CONNECT_SETUP: "Configurar",
  ACCOUNT_ANIMU_CONNECT_UPDATE: "Atualizar",
  ACCOUNT_ANIMU_CONNECT_FORM_HINT:
    "Defina ou altere suas credenciais do Animu Connect.",
  ACCOUNT_AVATAR: "Avatar",
  ACCOUNT_AVATAR_UPLOAD: "Enviar imagem",
  ACCOUNT_AVATAR_RESET: "Restaurar avatar do provedor",
  ACCOUNT_AVATAR_UPDATED: "Avatar atualizado",
  ACCOUNT_AVATAR_RESET_DONE: "Avatar restaurado",
  ACCOUNT_IMAGE_PERMISSION: "Permita o acesso às fotos para trocar seu avatar.",
  ...
  ACCOUNT_CREDENTIALS_FAILED: "Confira sua senha atual e tente novamente.",
  ACCOUNT_CREDENTIALS_SAVED: "Animu Connect atualizado",
  ACCOUNT_SAVE: "Salvar",
  ACCOUNT_NEW_PASSWORD: "Nova senha",
  ACCOUNT_CURRENT_PASSWORD: "Senha atual",
  ACCOUNT_CURRENT_PASSWORD_REQUIRED: "Digite sua senha atual.",
  ACCOUNT_CURRENT_PASSWORD_PLACEHOLDER: "Obrigatória para alterar",
  SETTINGS_ACCOUNT_MANAGE: "Gerenciar",
