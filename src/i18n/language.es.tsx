...
const DICT = {
  ...
  SETTINGS_ACCOUNT_CONNECTED: "Conectado a Discord",
  SETTINGS_ACCOUNT_LOGOUT: "Cerrar sesión",
  ...
  SETTINGS_QUALITY_LIVE_OFF_HINT: "No cargar imágenes de portada",
  ...
  SETTINGS_VISUALIZER_HZ_LABEL: "Frecuencia (Hz):",
  SETTINGS_VISUALIZER_OFF: "Apagado",
