...
const DICT = {
  ...
  SETTINGS_QUALITY_LIVE_LABEL: "Calidad de las imágenes (todas las portadas):",
  ...
  SETTINGS_STORAGE_MANAGE: "Detalles del almacenamiento",
  STORAGE_EXPLAIN:
  ...
  LOGIN_ANIMU_CONNECT_HINT:
    "Animu Connect debe estar configurado en tu perfil antes de usarlo aquí.",
  LOGIN_CONNECT_SUBTITLE: "Usa tu usuario y contraseña de Animu Connect",
  LOGIN_USERNAME: "Usuario",
  LOGIN_USERNAME_PLACEHOLDER: "Tu usuario de Animu Connect",
  ...
  ACCOUNT_TAP_TO_REVEAL: "Toca para ver",
  ...
  ACCOUNT_LAST_PROVIDER: "Conserva al menos una cuenta vinculada.",
  ACCOUNT_LINK_SUCCESS: "Cuenta vinculada",
  ACCOUNT_UNLINK_SUCCESS: "Cuenta desvinculada",
  ACCOUNT_ANIMU_CONNECT: "Animu Connect",
  ACCOUNT_ANIMU_CONNECT_DESC: "Inicia sesión con usuario y contraseña.",
  ...
  ACCOUNT_ANIMU_CONNECT_UPDATE: "Actualizar",
  ACCOUNT_ANIMU_CONNECT_FORM_HINT:
    "Define o cambia tus credenciales de Animu Connect.",
  ACCOUNT_AVATAR: "Avatar",
  ACCOUNT_AVATAR_UPLOAD: "Subir imagen",
  ACCOUNT_AVATAR_RESET: "Restaurar avatar del proveedor",
  ACCOUNT_AVATAR_UPDATED: "Avatar actualizado",
  ACCOUNT_AVATAR_RESET_DONE: "Avatar restaurado",
  ACCOUNT_IMAGE_PERMISSION:
    "Permite el acceso a las fotos para cambiar tu avatar.",
  ...
  ACCOUNT_CREDENTIALS_FAILED:
    "Revisa tu contraseña actual e inténtalo de nuevo.",
  ACCOUNT_CREDENTIALS_SAVED: "Animu Connect actualizado",
  ACCOUNT_SAVE: "Guardar",
  ACCOUNT_NEW_PASSWORD: "Nueva contraseña",
  ACCOUNT_CURRENT_PASSWORD: "Contraseña actual",
  ACCOUNT_CURRENT_PASSWORD_REQUIRED: "Escribe tu contraseña actual.",
  ACCOUNT_CURRENT_PASSWORD_PLACEHOLDER: "Necesaria para cambiar",
  SETTINGS_ACCOUNT_MANAGE: "Gestionar",
