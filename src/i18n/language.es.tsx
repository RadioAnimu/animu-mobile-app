...
import logo from "@/assets/logo_ES.webp";
import makeRequest from "@/assets/make_request_harukinha_es.webp";
import lastPlayed from "@/assets/last_played-haru_es.webp";
import lastRequested from "@/assets/last_requested-haru_es.webp";
...
const PROGRAMS: Program[] = [
  {
    ...
    information:
      "Animu NON-STOP es el bloque donde Animu nunca se detiene: suenan las mejores canciones sin parar mientras tú, oyente, puedes comandar la secuencia en cualquier momento.",
  },
  {
...
const DICT: Dict = {
  ...
  SETTINGS_STORAGE_PLAYED: "Reproducidas recientemente",
  SETTINGS_STORAGE_SEARCH: "Búsqueda de solicitudes",
  SETTINGS_STORAGE_EMPTY: "Sin portadas guardadas por ahora",
  ...
  SETTINGS_STORAGE_FREE_UP: "Liberar espacio",
  ...
  A11Y_OPENS_SETTINGS: "Abre los ajustes",
  A11Y_OPENS_LOGIN: "Abre el inicio de sesión",
  ...
  STATS_SETTINGS_ROW: "Estadísticas de escucha",
  STATS_TITLE: "Estadísticas de escucha",
  STATS_OVERVIEW_TITLE: "Resumen",
  STATS_TOTAL: "Tiempo total escuchando",
  STATS_DAYS: "Días escuchando",
  STATS_SESSIONS: "Sesiones",
  STATS_SONGS: "Canciones escuchadas",
  STATS_REQUESTED: "Solicitadas escuchadas",
  STATS_REQUESTS_SENT: "Solicitudes enviadas",
  STATS_SHOUTOUTS: "Saludos en vivo",
  STATS_STREAK_TITLE: "Racha",
  STATS_STREAK_CURRENT: "Racha actual",
  ...
  STATS_LESS: "Menos",
  STATS_MORE: "Más",
  STATS_PROFILE_TITLE: "Perfil de escucha",
  STATS_PROFILE_HOURS: "Por hora del día",
  STATS_PROFILE_WEEKDAYS: "Por día de la semana",
  STATS_PROFILE_EMPTY: "Aún no hay suficiente escucha registrada",
  STATS_EMPTY_TITLE: "Aún no hay escucha registrada",
  STATS_EMPTY:
  ...
  ABOUT_RELEASE_ROW: "Distribución",
  ABOUT_OTA_VERSION_ROW: "Versión OTA",
  ABOUT_OTA_BUILTIN: "Integrada",
  ABOUT_OTA_LOADING: "…",
  ABOUT_PACKAGE_ROW: "Paquete",
  ABOUT_RELEASE_APP_STORE: "App Store",
  ABOUT_RELEASE_ADHOC: "AltStore (Ad-Hoc)",
  ABOUT_RELEASE_DEVELOPMENT: "Desarrollo",
  ...
  STORAGE_CLEAR_CONFIRM_TITLE: "¿Liberar espacio?",
  STORAGE_CLEAR_CONFIRM_MSG:
    "Se eliminarán todas las portadas guardadas. Se volverán a descargar la próxima vez que escuches.",
  ...
  LOGIN_CODE_CHANGE_EMAIL: "Usar otro correo",
  LOGIN_CODE_INVALID: "Ese código no es válido o expiró. Inténtalo de nuevo.",
  ...
  ACCOUNT_NOT_LINKED: "Sin vincular",
  ...
  ACCOUNT_ACTION_FAILED: "La acción falló. Inténtalo de nuevo.",
  ACCOUNT_SAVE: "Guardar",
  ACCOUNT_EMAIL_ADD: "Añadir correo",
  ACCOUNT_EMAIL_SAVED: "Correo guardado",
  ACCOUNT_EMAIL_TAKEN: "Ese correo ya está en uso.",
